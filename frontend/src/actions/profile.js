...
export const getProfiles = () => async dispatch => {
    ...
    try {
        const res = await axios.get('http://docker_example.local/api/profile')
        dispatch({
            type: GET_PROFILES,
            payload: res.data
        })
...
export const getProfileById = userId => async dispatch => {
    try {
        const res = await axios.get(`http://docker_example.local/api/profile/user/${userId}`)
        dispatch({
            type: GET_PROFILE,
            payload: res.data
        })
...
export const getGetGithubRepos = username => async dispatch => {
    try {
        const res = await axios.get(`http://docker_example.local/api/profile/github/${username}`)
        dispatch({
            type: GET_REPOS,
            payload: res.data
        })
